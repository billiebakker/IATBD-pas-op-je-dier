<x-app-layout>
    <div class="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8">
        ...
        <form method="POST" action="{{ route('pets.update', $pet) }}" class="mt-6 space-y-6" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
            ...
            <div>
                ...
                <select name="type" id="type" class="mt-1 block w-full" required>
                    ...
                    <option value="reptile" {{ old('type', $pet->type) == 'reptile' ? 'selected' : '' }}>Reptile</option>
                    <option value="hamster" {{ old('type', $pet->type) == 'hamster' ? 'selected' : '' }}>Hamster</option>
                    <option value="insect" {{ old('type', $pet->type) == 'insect' ? 'selected' : '' }}>Insect</option>
                </select>
            ...
            <div>
                ...
                <x-text-input id="age" name="age" type="number" class="mt-1 block w-full" :value="old('age', $pet->age)"/>
